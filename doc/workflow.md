...
| EXECUTE | developer | lean-ctx (read/edit), gitnexus (impact) | `java-developer`, `test-driven-development` |
| EXECUTE_SCORED | tech-lead | lean-ctx (scoring) | `doubt-driven-development` (DDD gate) |
| REVIEW | quality-analyst | lean-ctx (read), gitnexus (impact), postgres (DB) | `code-review-and-quality`, `qa-expert`, `security-expert` |
